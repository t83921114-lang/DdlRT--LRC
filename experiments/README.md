# ClusterRT_LRC overnight experiments
...
The parser supports ClusterRT_LRC summary lines containing pairs, `migration_sum`, `parity_sum`, `critical_path`, and `end_to_end`.
