#!/usr/bin/env python3
"""Plan and run the ClusterRT-LRC overnight experiment matrix."""
...
CLIENT_FAILURE_RE = re.compile(
    ...
    r"merge returned failure|merge stopped early|ClusterRT_LRC round RPC failed|"
    r"ClusterRT_LRC round failed|merge round failed; stopping)", re.I)
...
def build_configurations(manifest: Dict[str, Any], experiments: Optional[Set[str]] = None,
    ...
    for encoding in manifest["encoding_parameters"]:
        base = {
            "code_type": ALGORITHM, "encoding": encoding["name"], "k": encoding["k"],
        ...
        with log_path.open("w", encoding="utf-8", buffering=1) as log:
            ...
            def consume_output(output: str) -> None:
                ...
                while True:
                    ...
                    # ClusterRT_LRC receives the merge round as a function argument,
